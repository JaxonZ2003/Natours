...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamF4b256eTIwMDMiLCJhIjoiY2x2ZzdqYXJvMGFjMTJpcHV2Y2QydGduMCJ9.dPIL51D6JcN5IgJFVLLZUg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/jaxonzy2003/clvg8j3t7008001ob9yr507wx',
    // style URL
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // the map variable we created at beginning
...
/* eslint-disable */
var stripe = Stripe('pk_test_51PAHwBKXRKhZUYBu3zUlNd8mFu3rh9PjpYY5OLwFwSmaDGwvndHAjRQzvbQwwvgLTKCXEHmrvRjaxwTWmtgCD2ir00xh0Ooq6P');
